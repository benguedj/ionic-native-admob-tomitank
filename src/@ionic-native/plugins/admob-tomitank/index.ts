...
@Plugin({
  ...
  plugin: 'cordova-plugin-admob-tomitank',
  pluginRef: 'admob',
  repo: 'https://github.com/tomitank/cordova-plugin-admob-tomitank',
...
export class AdMobFree extends IonicNativePlugin {
  ...
  getTrackingStatus(): Promise<any> { return; }
   ...
   */
  @Cordova({ otherPromise: true })
  trackingStatusForm(): Promise<any> { return; }
